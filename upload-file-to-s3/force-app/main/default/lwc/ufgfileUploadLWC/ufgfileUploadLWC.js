...
import getDocumentsbyApp from '@salesforce/apex/documentController.getDocumentsbyApp';
...
export default class fileUploadLWC extends LightningElement {
    ...
    getUploadedFiles(){
        displayUploadedFiles(this.recordId)
        .then(data => {
            this.tableData = data;
    ...
    //@wire(getDocumentsbyApp,{parentId: '$recordId'})
     @wire(getDocumentsbyApp, {parentId: "$getIdFromParent"})
//    @wire(getDocumentsbyApp, {parentId: 'a008b00000xrh5bAAA'})
